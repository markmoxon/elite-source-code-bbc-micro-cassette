...
all:
	...
	cat elite-music/elite-music.rom 3-assembled-output/rom-extra1.bin 3-assembled-output/rom-extra2.bin 3-assembled-output/rom-extra3.bin 3-assembled-output/rom-extra4.bin 3-assembled-output/rom-extra5.bin 3-assembled-output/rom-extra6.bin 3-assembled-output/rom-extra7.bin 3-assembled-output/rom-extra8.bin > 3-assembled-output/elite-music.rom
...
uef: all
	...
	$(PHP) 2-build-files/tibetuef-0.12.php +nz temp.tbt 5-compiled-game-discs/elite-cassette$(suffix).uef
ifeq ($(OS), Windows_NT)
	del /Q /F temp.tbt
else
	rm temp.tbt
