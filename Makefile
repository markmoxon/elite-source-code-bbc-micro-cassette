...
all:
	...
	cat 1-source-files/music/elite-music.rom 3-assembled-output/rom-extra1.bin 3-assembled-output/rom-extra2.bin 3-assembled-output/rom-extra3.bin 3-assembled-output/rom-extra4.bin 3-assembled-output/rom-extra5.bin 3-assembled-output/rom-extra6.bin 3-assembled-output/rom-extra7.bin 3-assembled-output/rom-extra8.bin 3-assembled-output/rom-extra9.bin > 3-assembled-output/elite-music.rom
